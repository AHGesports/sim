...
This refers to: ["apps/sim/tools/**", "apps/sim/blocks/**", "apps/sim/triggers/**"]

Read the full rule [here](.cursor/rules/sim-integrations.md)

# Sim Queries

>React Query patterns for the Sim application
This refers to: ["apps/sim/hooks/queries/**/*.ts"]

Read the full rule [here](.cursor/rules/sim-queries.md)
...
This refers to: ["apps/sim/**/*.test.ts", "apps/sim/**/*.test.tsx"]

Read the full rule [here](.cursor/rules/sim-testing.md)
